...
- Подготовлены два варианта представления:
	- [lr2/code/sneps_logic.sneps](lr2/code/sneps_logic.sneps) — пояснительная версия;
	- [lr2/code/sneps_ready.sneps](lr2/code/sneps_ready.sneps) — версия для загрузки в SNePS.
	- Подготовлены тесты в [lr2/tests/tests.sneps](lr2/tests/tests.sneps).
	- Построена ER-диаграмма в [lr2/er_diagram.mmd](lr2/er_diagram.mmd).
...
## Вывод
Модель предметной области для ЛР2 собрана и проверена. Иерархия понятий, вывод по `ISA`, перенос `instance-of` и проверка отношений работают корректно.
